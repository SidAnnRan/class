...
**Committing** and **pushing** are how you can add the changes you made on your local machine to the remote repository in GitHub. Note that at least for the first few assignements of the course, we won't be dealing with committing and pushing to Git. Instead, 
you will submit your solutions through ICON.

You can make a commit when you have made changes to your project that you want to “checkpoint.” You can also add a helpful **commit message** to remind yourself or your teammates what work you did (e.g. “Added a README with information about our project”). Once you have a commit or multiple commits that you’re ready to add to your repository, you can use the 
push command to add those changes to your remote repository.
...
The following Github features are important and particularly useful when maintaining large projects,
developed by large teams. Our assignments will be done individually and most of them will be 
limited in size, so we might not be able to see the full power of these features. Some of them
might be more meaningful to try when we work on the project. Otherwise, I will try to 
demonstrate their utility using examples if we have time.
