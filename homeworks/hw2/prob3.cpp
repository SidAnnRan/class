...
void menu(/* Fill args, if any*/);
//Bitwise AND
void bAndBin(/* Fill args, if any*/);
//Bitwise OR
void bOrBin(/* Fill args, if any*/);
//Bitwise XOR
void bXorBin(/* Fill args, if any*/);
//Bitwise NOT
void bNotBin(/* Fill args, if any*/);
//Left shift
void lShiftBin(/* Fill args, if any*/);
//Right shift
void rShiftBin(/* Fill args, if any*/);
//Addition
void bAddBin(/* Fill args, if any*/);
...
int main() {
    ...
    dec1a = bin2Dec(/* Fill args, if any*/);
    dec2a = bin2Dec(/* Fill args, if any*/);
...
int exp2 (int m) {
    //Fill body, and change return value if necessary
    return 0;
}
